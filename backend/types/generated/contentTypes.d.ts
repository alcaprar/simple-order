...
export interface PluginUsersPermissionsUser extends Schema.CollectionType {
  ...
  attributes: {
    ...
    role: Attribute.Relation<
      ...
      'plugin::users-permissions.role'
    >
    shop: Attribute.Relation<'plugin::users-permissions.user', 'oneToOne', 'api::shop.shop'>
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
export interface ApiClientClient extends Schema.CollectionType {
  ...
  attributes: {
    username: Attribute.String
    shop: Attribute.Relation<'api::client.client', 'manyToOne', 'api::shop.shop'>
    name: Attribute.String
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
...
export interface ApiOrderOrder extends Schema.CollectionType {
  ...
  attributes: {
    client: Attribute.Relation<'api::order.order', 'oneToOne', 'api::client.client'>
...
export interface ApiProductSaleProductSale extends Schema.CollectionType {
  ...
  attributes: {
    ...
    amount_in_minor: Attribute.Integer
    sale: Attribute.Relation<'api::product-sale.product-sale', 'manyToOne', 'api::sale.sale'>
    ...
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::product-sale.product-sale', 'oneToOne', 'admin::user'> &
      Attribute.Private
    updatedBy: Attribute.Relation<'api::product-sale.product-sale', 'oneToOne', 'admin::user'> &
      Attribute.Private
  }
}
...
export interface ApiSaleSale extends Schema.CollectionType {
  ...
  attributes: {
    ...
    createdAt: Attribute.DateTime
    updatedAt: Attribute.DateTime
    createdBy: Attribute.Relation<'api::sale.sale', 'oneToOne', 'admin::user'> & Attribute.Private
    updatedBy: Attribute.Relation<'api::sale.sale', 'oneToOne', 'admin::user'> & Attribute.Private
  }
}
...
export interface ApiShopShop extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String
    products: Attribute.Relation<'api::shop.shop', 'oneToMany', 'api::product.product'>
    clients: Attribute.Relation<'api::shop.shop', 'oneToMany', 'api::client.client'>
